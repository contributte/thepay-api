...
/**
 * Class Tp\FerBuy\TpFerBuyCart represents user cart.
 */
class Cart
{
	...
	private function setCurrency($currency)
	{
		if (strlen($currency) == 3) {
			...
			throw new InvalidArgumentException('Currency must be exactly 3 characters long');
		}
	}
	...
	{
		if ( !is_numeric($tax)) {
			throw new InvalidArgumentException('Tax has to be numeric.');
		}
	...
	public function setDiscount($discount)
	{
		if ( !is_numeric($discount)) {
			throw new InvalidArgumentException('Discount has to be numeric.');
		}
	...
	public function setShipping($shipping)
	{
		if ( !is_numeric($shipping)) {
			throw new InvalidArgumentException('Shipping has to be numeric.');
		}
